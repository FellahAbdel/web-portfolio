...
$trad = [
  ...
  "adminPageTitle" => [
    ...
    "insertArticle" => "Ajouter un nouvel article",
    "updateArticle" => "Modifier cet article",
  ...
  "AdminProjectForm" => [
    ...
    "project image" => "Sélectionnez l'image du projet",
    ...
    "n-response" => "Non",
    "go-back-btn" => "Retour",
    "insert-subtitle" => "Remplissez les informations du nouveau projet.",
    "edit-subtitle" => "Modifiez les informations du projet.",
  ...
  "AdminArticleForm" => [
    ...
    "text alt" => "Texte alternatif de l'image",
    "image" => "Selectionnez l'image de l'article !",
    "upload button" => "Ajouter l'article",
    "update button" => "Modifier l'article",
    "delete button" => "Supprimer l'article",
    "question" => "Voulez-vous vraiment supprimer cet article ?",
    "y-response" => "Oui",
    "n-response" => "Non",
    "go-back-btn" => "Retour",
  ],
